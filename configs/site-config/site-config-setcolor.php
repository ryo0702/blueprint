...
// Colorgroup
if (file_exists(NUTRAIL_THEME_DIR.'configs/options/option-common-colorgroup.php')) {
    $colors = include NUTRAIL_THEME_DIR.'configs/options/option-common-colorgroup.php';
...
// Color
if (file_exists(NUTRAIL_THEME_DIR.'configs/options/option-common-color.php')) {
...
// Design Content
if (file_exists(NUTRAIL_THEME_DIR.'configs/options/option-common-design-content.php')) {
    require_once NUTRAIL_THEME_DIR.'configs/options/option-common-design-content.php';
