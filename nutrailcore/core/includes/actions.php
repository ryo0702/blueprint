...
if (!function_exists('wpa_create_page_widgets')) {
    function wpa_create_page_widgets()
    {
        ...
        // update new widget
        if (file_exists(NUTRAIL_PRESET_PATH.'/widgets/'.$widget_id.'.php')) {
            $data_widgets = include NUTRAIL_PRESET_PATH.'/widgets/'.$widget_id.'.php';
...
if (!function_exists('wpa_import_widgets')) {
    function wpa_import_widgets()
    {
        ...
        if (isset($_GET['import-theme-options'])) {
            ...
            if (file_exists(NUTRAIL_PRESET_PATH.'/options/'.$option_name.'.php')) {
                $theme_option = include NUTRAIL_PRESET_PATH.'/options/'.$option_name.'.php';
        ...
        if (!empty($widgets)) {
            ...
            foreach ($widgets as $widget) {
                $widget_path = NUTRAIL_PRESET_PATH.'/widgets/'.$widget.'.php';
