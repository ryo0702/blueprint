...
function load_contactform_input_type()
{
    return array(
        'input_name'            => 'お名前',
        'input_email'           => 'メールアドレス',
        'input_phone_number'    => '電話番号',
        'input_sp_phone_number' => '携帯電話番号',
        'input_text'            => 'テキスト',
        'input_date'            => '日にち',
        'input_textarea'        => 'テキストエリア',
        'input_radio_yesno'     => 'はい・いいえ',
        'input_select'          => 'セレクトボックス',
        'input_hidden_title_get_id' => 'パラーメーター(ID)',
    );
}
