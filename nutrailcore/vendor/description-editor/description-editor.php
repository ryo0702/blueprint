 ...
 * @since 1.0
 */
if (!class_exists('Nutrail_Descriptions_Editor') && !class_exists('RankMath\Admin\Metabox\Taxonomy_Screen')) :
    class Nutrail_Descriptions_Editor
    {
        /**
        ...
        public function load_taxonomy()
        {
            ...
            $taxonomies = apply_filters('wpa_term_description_taxonomies', $taxonomies);

            if (!empty($screen->taxonomy)) {

                $this->taxonomy = apply_filters('wpa_term_description_taxonomy', $screen->taxonomy);
        ...
        {
            wp_enqueue_script('wpa-description-editor-word-count', NUTRAIL_CORE_URL.'vendor/description-editor/wordcount.js',
                ['jquery', 'underscore', 'word-count']
            );
        }
        ...
        private function editor_word_count()
        {
            ...
            <div id="post-status-info">
                <div id="description-word-count" class="hide-if-no-js" style="padding: 5px 10px;">
                    <?php printf(
                        esc_html__('Word count: %s', 'nutrail'),
        ...
        public function render_field_edit($tag, $taxonomy)
        {
            ...
            <tr class="form-field term-description-wrap">
                <th scope="row">
                    <label for="description"><?php esc_html_e('Description', 'nutrail'); ?></label>
                </th>
                <td>
                    <?php
                    ...
                    ?>
                    <p class="description"><?php esc_html_e('The description is not prominent by default; however, some themes may show it.', 'nutrail'); ?></p>
                </td>
                <script>
        ...
        public function render_field_add($taxonomy)
        {
            ...
            <div class="form-field term-description-wrap">
                <label for="tag-description"><?php esc_html_e('Description', 'nutrail'); ?></label>
                <?php
                ...
                ?>
                <p><?php esc_html_e('The description is not prominent by default; however, some themes may show it.', 'nutrail'); ?></p>
    ...
    new Nutrail_Descriptions_Editor();
endif;
