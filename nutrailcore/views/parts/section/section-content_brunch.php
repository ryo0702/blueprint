...
if(is_array(@$config_page[$section_view_config_key.'_content'])){
    foreach ($config_page[$section_view_config_key.'_content'] as $sec_content) {
        $children_content[] = html_pileup_content(array(
            'type' => 'brunch',
            'layout' => $config_page[$section_view_config_key.'_layout'],
            'title' => @$sec_content[$section_view_config_key.'_title'],
            'tel' => @$sec_content[$section_view_config_key.'_tel'],
            'address' => @$sec_content[$section_view_config_key.'_address'],
            'image' => @$sec_content[$section_view_config_key.'_img'],
            'link' => @$sec_content[$section_view_config_key.'_link'],
        ));
    }
}
...
$pileup_html = array(
    array(
        'elem' => 'section','class' => array('section',@$config_page[$section_view_config_key.'_class']),'style' => array('background-color' => @$config_page[$section_view_config_key.'_bgc'],'color' => @$config_page[$section_view_config_key.'_color'],'background-image' => @$config_page[$section_view_config_key.'_bgi']['url']),'content' => array(
            array(
