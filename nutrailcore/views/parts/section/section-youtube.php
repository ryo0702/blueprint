...
$pileup_html = array(
    array(
        ...
        'content' => array(
            ...
            array('elem' => 'div','class' => array('container-xs'),'content' => array(
                    array('elem' => 'div','class' => array(@$config_page[$section_view_config_key.'_inner_classset'],@$config_page[$section_view_config_key.'_inner_class'],'mb-wrap-20px'),'content' => array(
                        array('elem' => 'div','class' => array(),'content' => array(
                            array(
                                'elem' => 'youtube','class' => array('youtube'),'src' => @$config_page[$section_view_config_key.'_youtubeid']
                            ),
                            array(
                                'elem' => 'p','class' => 'text-center ffs-xs fmt-s',
                                'content' => @$config_page[$section_view_config_key.'_caption'],
                                'br' => true
                            ),
                        )),
                        array('elem' => 'div','class' => array(),'content' => array(
                            array(
                                'elem' => 'youtube','class' => array('youtube'),'src' => @$config_page[$section_view_config_key.'2_youtubeid']
                            ),
                            array(
                                'elem' => 'p','class' => 'text-center ffs-xs fmt-s',
                                'content' => @$config_page[$section_view_config_key.'2_caption'],
                                'br' => true
                            ),
                        )),
                        array('elem' => 'div','class' => array(),'content' => array(
                            array(
                                'elem' => 'youtube','class' => array('youtube'),'src' => @$config_page[$section_view_config_key.'3_youtubeid']
                            ),
                            array(
                                'elem' => 'p','class' => 'text-center ffs-xs fmt-s',
                                'content' => @$config_page[$section_view_config_key.'3_caption'],
                                'br' => true
                            ),
                        )),
                    ),
